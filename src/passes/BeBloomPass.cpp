...
auto BeBloomPass::Initialise() -> void {
    ...
    _brightMaterial = BeMaterial::Create("Bright Pass Material", false, _brightShader, *_renderer);
    ...
    _addMaterial = BeMaterial::Create("Add Pass Material", false, _addShader, *_renderer);
