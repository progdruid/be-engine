...
private:
    std::unordered_map<std::string, std::string> _textureValues;
...
public:
    ...
    auto SetTexture(const std::string& propertyName, const std::string& texturePath) -> void;
    ...
    auto GetTexture(const std::string& propertyName) -> std::string;
